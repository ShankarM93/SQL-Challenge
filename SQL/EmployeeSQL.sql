...
-- copying csv to sql
COPY titles
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\titles.csv'
DELIMITER ','
CSV HEADER;
-- show table
SELECT * FROM titles;
...
-- copying csv to sql
COPY employees
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\employees.csv'
DELIMITER ','
CSV HEADER;
...
-- copying csv to sql
COPY departments
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\departments.csv'
DELIMITER ','
CSV HEADER;
-- show table
...
-- copying csv to sql
COPY salaries
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\salaries.csv'
DELIMITER ','
CSV HEADER;
-- show table
...
-- copying csv to sql
COPY dept_emp
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\dept_emp.csv'
DELIMITER ','
CSV HEADER;
-- show table
...
-- copying csv to sql
COPY dept_manager
FROM 'C:\Users\Admin\Desktop\Module9SQL-Challenge\data\dept_manager.csv'
DELIMITER ','
CSV HEADER;
-- show table
